...
#chatbot
{
  ...
  <div class="container">
	...
	<div id="on" class="w3-container w3-center w3-animate-zoom" onclick="off()">
		<h1 id="type"></h1>
		<p style="font-family: sans-serif;">Government agencies are responsible for setting food safety standards, conducting inspections, ensuring that standards are met, and maintaining a strong enforcement program to deal with those who do not comply with standards.</p>
	</div>
...
<div id="main" style="background-color:#fff;"><br><br><br>
	...
	<div style="float:right;margin-top:-80px;border-background-color:2px red solid;width=100%;"><span id="user"></span></div>
